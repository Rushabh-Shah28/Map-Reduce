...
public class ParseReducer extends Reducer <Text, Node, WritableComparable, Writable> {
    ...
    private MapWritable NumberPageMap;
    ...
    public void setup(Context context){
        ...
        this.counter = 0;
        this.NumberPageMap  = new MapWritable();
    ...
    public void cleanup(Context context) throws IOException, InterruptedException{
        ...
        outputs.write(CONSTANTS.StringToNumberMapFileIdentifier,new IntWritable(reduceId), this.NumberPageMap, CONSTANTS.StringToNumberFilePathPrefix);
    ...
    public void addToMap(String name){
        ...
        if(!this.NumberPageMap.containsKey(pageName)){
            LongWritable rowNumber = new LongWritable(this.counter++);
            this.NumberPageMap.put(pageName, rowNumber);
        }
    }
}