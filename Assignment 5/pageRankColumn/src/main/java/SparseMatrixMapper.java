...
public class SparseMatrixMapper extends Mapper <Text, Node, WritableComparable, Writable>{
    ...
    public void map(Text key, Node value, Context ctx) throws IOException, InterruptedException{
        ...
        for(String node: value.adjacencyList){
            ...
            ctx.write(keyToLongWritbale , new ContributionValue(nodeToLongWritbale.get(), 1.0/value.adjacencyList.size()));
        }
