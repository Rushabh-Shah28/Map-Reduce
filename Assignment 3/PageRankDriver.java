...
public class PageRankDriver {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Time taken for preProcessing:" + execTime);
        ...
        endTime = System.currentTimeMillis();
        execTime = endTime-startTime;
        System.out.println("Time taken for 10 iterations of Page Rank: " + execTime);
        ...
        endTime = System.currentTimeMillis();
        execTime = endTime-startTime;
        System.out.println("Time taken to find top 100 pages: " + execTime);
    }
}