...
public class nolock_thread implements Runnable {
    ...
    public nolock_thread(int start , int end , ArrayList<String> weatherData, HashMap<String,Double> station_temperature,
